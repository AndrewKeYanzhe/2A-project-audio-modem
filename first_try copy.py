...
received_signal = load_data('transmitted.csv')
...
encodings_to_try = ['utf-8', 'utf-16', 'latin-1', 'ascii']

for encoding in encodings_to_try:
    try:
        decoded_string = bytes_data.decode(encoding)
        print(f"Decoded using {encoding}: {decoded_string}")
