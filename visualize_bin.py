...
def extract_OFDM_bins(binary_string, num_bins=65536, fs=48000, f_low=20, f_high=8000):
...
bin_file_path2 = 'binaries/received_binary_0522_2304.bin'
...
print(len(binary_string1)/65534)
print(len(binary_string2)/65534)
